...
# oldfilename = r'C:\Users\EastmanE\Desktop\ProtocolCare\zTosh\Formatted_Protocols_2019.xlsx'
# newfilename = r'C:\Users\EastmanE\Desktop\ProtocolCare\zTosh\Formatted_Protocols_20210405151618.xlsx'
def Toshiba(oldfilename, newfilename):
        ...
        for j in removed_edit:
            ...
            if (len(w_add) > 6) | (len(w_rem) > 6):
                if (len(w_rem) <3) & (len(w_add_2) <3):
                    same_edit[i] = j
                    if (i not in remove_add_dict) & (j not in remove_rem_dict):
                        remove_add_dict.append(i)
                        remove_rem_dict.append(j)
